...
タブレット端末での操作性を考慮し、タップしやすいターゲットサイズと余白を確保しました。配色は視認性を重視し、選択状態や操作可否を色で明確に区別しています。`,
  ...
  },
  {
    ...
    tagClassName: 'bg-blue-500',
    summary:
      '清潔感と信頼感を重視した、歯科クリニック向けコーポレートサイトのWebデザインです。',
    description: `歯科クリニックのコーポレートサイトを、清潔感と信頼感を軸にデザインしました。青と白を基調としたカラーパレットで、医療機関としての安心感と現代的な洗練さの両立を目指しています。

メインカラーには爽やかなブルーを採用し、ベースは白とライトグレーのグラデーションで柔らかい印象にしています。アクセントは青の濃淡で視線誘導を意識しました。

スクロールに応じて展開する7セクション構成とし、各セクションに役割を持たせた情報設計です。アイコンとビジュアルで視認性を高め、カードデザインで情報のグルーピングを明確にしています。ユーザーが直感的に情報へアクセスできるよう、視覚的な階層とわかりやすいナビゲーションも重視しました。

タイポグラフィは可読性の高い日本語フォントを選定し、行間とフォントサイズで読みやすさを確保しています。`,
...
コンセプトは「新生活 × 無料 × みんなと一緒」。水色と桜色を軸に、春らしさと親しみやすさを両立したトーンで制作しました。`,
  ...
  },
  {
    ...
    images: ['/images/cofitComplete.jpeg','/images/login.jpeg','/images/regestar.jpeg','/images/home.jpeg','/images/profile.jpeg','/images/set.jpeg'],
    tagClassName: 'bg-orange-500',
